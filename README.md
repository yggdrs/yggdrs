...
Edit `env-config.js` and replace `'Yggds'` by your project name.

Edit `next.config.js` and replace `'Yggds'` by your project name.
...
```bash
https://github.com/thierryc/Yggds/

https://thierryc.github.io/Yggds/
```
